...
@asistencias_router.get('/asistencias/id_curso/{id_curso}')
...
@asistencias_router.get('/asistencias/legajo/{legajo}')
...
@asistencias_router.get('/asistencias/fecha/{fecha}')
...
@asistencias_router.delete('/{id_curso}/{legajo}/{fecha}')
